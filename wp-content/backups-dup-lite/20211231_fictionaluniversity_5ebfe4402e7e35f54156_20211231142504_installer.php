...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211231_fictionaluniversity_5ebfe4402e7e35f54156_20211231142504_archive.zip';
	const ARCHIVE_SIZE		 = '21670066';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5ebfe44-31142504';
    const SECONDARY_PACKAGE_HASH = '08982b6-31142504';
	const VERSION			 = '1.4.3';
